function SiteMembers (collectionId, baseUrl, smVarOnWindow, metaSiteId) {
    ...
    var svSession = cookieManager.getCookie("svSession");
    if (svSession) {
        actions.login = "/api/member/login/?email={0}&password={1}&rememberMe={2}&svSession={3}&appUrl={4}";
        actions.register = "/api/member/register?email={0}&password={1}&svSession={2}&appUrl={3}";
        actions.loginWithInitiator = "/api/member/login/?email={0}&password={1}&rememberMe={2}&initiator={3}&svSession={4}&appUrl={5}";
        actions.registerWithInitiator = "/api/member/register?email={0}&password={1}&svSession={2}&initiator={3}&appUrl={4}";
        actions.applyWithInitator = "/api/member/apply?email={0}&password={1}&svSession={2}&initiator={3}&appUrl={4}";
    }
    ...
    return {
        ...
        login: function (email, password, rememberMe, onSuccess, onError, initiator) {
            ...
            if (svSession) {
                ...
                if (initiator) {
                    _sendAction("loginWithInitiator", params, onSuccess, onError);
                } else {
                    _sendAction("login", params, onSuccess, onError);
                }
        ...
        register: function (email, password, onSuccess, onError, initiator) {
            ...
            if (svSession) {
                ...
                if (initiator) {
                    _sendAction("registerWithInitiator", params, onSuccess, onError);
                } else {
                    _sendAction("register", params, onSuccess, onError);
                }
        ...
        apply: function (email, password, onSuccess, onError) {
            ...
            if (svSession) {
                ...
                _sendAction("applyWithInitator", params, onSuccess, onError);
